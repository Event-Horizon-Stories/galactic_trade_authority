defmodule GalacticTradeAuthority.Resources.AuditRecord do
  @moduledoc """
  ...
  relationships do
    belongs_to :actor, GalacticTradeAuthority.Resources.Trader do
      allow_nil?(false)
      attribute_writable?(true)
      public?(true)
    end

    belongs_to :shipment, GalacticTradeAuthority.Resources.Shipment do
      attribute_writable?(true)
      public?(true)
    end

    belongs_to :shadow_report, GalacticTradeAuthority.Resources.ShadowReport do
      attribute_writable?(true)
      public?(true)
    end
  end
