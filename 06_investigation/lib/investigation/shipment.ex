defmodule Investigation.Shipment do
  use Ash.Resource,
  ...
  actions do
    ...
    create :register_standard do
      ...
      validate(
        {Investigation.Validations.DistinctRoute,
         left: :origin_planet_id, right: :destination_planet_id}
      )

      change(Investigation.Changes.ApplyRegulatoryOutcome)
  ...
  relationships do
    ...
    belongs_to :contract, Investigation.Contract do
      attribute_writable?(true)
      public?(true)
    end
  end
